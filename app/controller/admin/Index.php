...
class Index
{
    ...
    public function checkUpdate(){
        ...
        // 使用当前维护仓库的版本文件检查更新。
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://raw.githubusercontent.com/LeoChen-CoreMind/vmqfox-backend/main/ver");
        ...
        if (sizeof($ver)==2 && $ver[0]!=Config::get("app.ver")){
            return json($this->getReturn(1,"[v".$ver[0]."已于".$ver[1]."发布]","https://github.com/LeoChen-CoreMind/vmqfox-backend"));
        }else{
